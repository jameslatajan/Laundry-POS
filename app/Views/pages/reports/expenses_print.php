                            ...
                            <table class="table table-borderless mb-2">
                                <thead>
                                    <tr>
                                        ...
                                        <td style="font-size: 10px; font-weight:bold">PARTICULAR</td>
                                        <td style="font-size: 10px; font-weight:bold">AMT</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if ($records) { ?>
                                        <?php foreach ($records as $rec) { ?>
                                            <tr>
                                                <td style="font-size: 7px;"><?php echo date('d/m/Y', strtotime($rec->expDate)) ?></td>
                                                <td style="font-size: 7px;"><?php echo $rec->particular ?></td>
                                                <td style="font-size: 7px;"><?php echo number_format($rec->amount, 2)  ?></td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                                </tbody>
