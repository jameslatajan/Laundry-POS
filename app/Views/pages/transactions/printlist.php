                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <table class="table table-borderless mb-2">
                                <thead>
                                    <tr>
                                        <td style="font-size: 10px; font-weight:bold">TRANS DATE</td>
                                        <td style="font-size: 10px; font-weight:bold">CUSTOMER</td>
                                        <td style="font-size: 10px; font-weight:bold">TTL DUE</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if (!empty($records)) { ?>
                                        <?php foreach ($records as $rec) { ?>
                                            <tr>
                                                ...
                                                <td style="font-size: 7px;"><?php echo number_format($rec->totalAmount, 2)  ?></td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                                </tbody>
